...
<section className="flex justify-center ">
  <div className="contant flex flex-wrap justify-center pl-0 lg:w-1/2 w-full" id="contant">
    <motion.div
    ...
    >
      ...
      <div className="contant-form flex justify-center items-center">
        <form action="https://formspree.io/f/myzgvobj" method="POST">
          <input type="text" name="name" placeholder="Enter Your Name" required />
          <input type="email" name="email" placeholder="Enter Your Email" required />
          <input type="text" name="subject" placeholder="Enter Your Subject" required />
          <textarea name="message" cols="1" rows="1" placeholder="Enter Your Message" required></textarea>
