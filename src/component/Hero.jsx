...
import Se7sProfile from '../assets/Se7sProfile.png'
  ...
  return <div className="border-b border-neutral-900 pb-4 lg:mb-36 ">
    <div className="flex flex-wrap  justify-around ">
        ...
        <div className="flex flex-col items-center lg:items-start">
            ...
            initial="hidden"
            animate="visible"
            className="pb-16 text-6xl font-thin tracking-tight lg:mt-16lg:text-8xl ">
              Hussein Ashraf </motion.h1>
            <motion.span 
        ...
        <div className="flex justify-between">
            ...
            src={Se7sProfile} alt="profilePic" />
        </div>
        </div>
    </div>
  </div>
